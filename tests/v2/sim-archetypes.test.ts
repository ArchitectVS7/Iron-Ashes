...
import { chooseAction, choosePledge, DEFAULT_AI_POLICY, type AIPolicy } from '../../src/v2/ai-player.js';
import { ARCHETYPES, ARCHETYPE_IDS, policyOf } from '../../src/v2/sim/archetypes.js';
import { playHeadlessGame, type SeatPolicies } from '../../src/v2/sim/driver.js';
import { WARLORD_POWER } from '../../src/v2/tunables.js';
