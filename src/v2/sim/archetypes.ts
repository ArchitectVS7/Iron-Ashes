...
export const ARCHETYPES: Readonly<Record<ArchetypeId, Archetype>> = Object.freeze({
  ...
  aggressor: {
    ...
    policy: {
      ...
      darkHuntBias: 0.7, oathWillingness: 0.2, oathLoyalty: 0.45, // fights more than it allies; sometimes betrays
    },
  },
  turtle: {
    id: 'turtle',
    ...
    policy: {
      ...
      darkHuntBias: 0.5, oathWillingness: 0.6, oathLoyalty: 0.9, // a loyal ally
    },
  },
  opportunist: {
    id: 'opportunist',
    ...
    policy: {
      ...
      darkHuntBias: 0.5, oathWillingness: 0.5, oathLoyalty: 0.5, // the schemer — swears, sometimes betrays
    },
  },
  cooperator: {
    id: 'cooperator',
    ...
    policy: {
      ...
      darkHuntBias: 0.6, oathWillingness: 0.8, oathLoyalty: 0.95, // the loyal allier (rescues forge Oaths)
    },
  },
  gambler: {
    id: 'gambler',
    ...
    policy: {
      ...
      darkHuntBias: 0.1, oathWillingness: 0.2, oathLoyalty: 0.5, // single-minded on the Gambit
    },
  },
  saboteur: {
    id: 'saboteur',
    ...
    policy: {
      ...
      darkHuntBias: 0.3, oathWillingness: 0.4, oathLoyalty: 0.45, // treacherous (already a traitor)
    },
  },
});
