...
export const ARCHETYPES: Readonly<Record<ArchetypeId, Archetype>> = Object.freeze({
  ...
  aggressor: {
    ...
    policy: {
      ...
      darkHuntBias: 0.7, // loves a fight — will bloody the dark for the land + the steer
    },
  },
  turtle: {
    id: 'turtle',
    ...
    policy: {
      ...
      darkHuntBias: 0.5, // clears the dark off its own contested ground
    },
  },
  opportunist: {
    id: 'opportunist',
    ...
    policy: {
      ...
      darkHuntBias: 0.5, // hunts when trailing (free land + steer the dark at the leader)
    },
  },
  cooperator: {
    id: 'cooperator',
    ...
    policy: {
      ...
      darkHuntBias: 0.6, // the heroic player — pushes the dark back for the table
    },
  },
  gambler: {
    id: 'gambler',
    ...
    policy: {
      ...
      darkHuntBias: 0.1, // single-minded on the Keystone — rarely detours to fight the dark
    },
  },
  saboteur: {
    id: 'saboteur',
    ...
    policy: {
      ...
      darkHuntBias: 0.3, // hunts for cover when not holding the Pact (sabotaging skips it)
    },
  },
});
