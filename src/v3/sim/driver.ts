...
export interface GameRunConfig {
  ...
  /**
   * DARK-STRENGTH difficulty tier (§D1). Applied as a doomCost-curve override UNDER `tunables`
   * (so an explicit balance-search override still wins). Unspecified ⇒ `warlord` (the locked
