> **T2-3 REFERENCE (2026-07-02): the DEFAULT game is now HERALD-OFF (3 archetypes).** This canonical
> run is the herald-OFF default after the T2-3 re-center (validated 2-seed: dark 18.9%/18.3%, per-count
> 2p 17.1/16.0 · 3p 23.3/23.3 · 4p 16.4/15.7, rounds 12.2, court-at-March 3, BP 15.8/69.4/78.1). The
> herald-ON variant is available via the setup toggle / `--herald` (1-seed sanity carried in the T2-3
> commit). Orchestrator-salvaged close-out: the stage agent validated the finalist but hit a session
