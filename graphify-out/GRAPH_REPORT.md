...
## Corpus Check
- 254 files · ~368,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2185 nodes · 5353 edges · 131 communities (125 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68d4fd1a`
...
2. `createGame()` - 67 edges
3. `GameState` - 67 edges
4. `getTunables()` - 58 edges
5. `GameState` - 49 edges
6. `applyCommand()` - 47 edges
7. `GameSession` - 46 edges
...
- `apply()` --calls--> `applyCommand()`  [EXTRACTED]
  tests/v3/hardening-4g.test.ts → src/v3/reducer.ts
- `apply()` --calls--> `applyCommand()`  [EXTRACTED]
...
Cohesion: 0.07
Nodes (56): bfsDistance(), BoardValidationResult, buildClosingRing(), createInitialBoardState(), BOARD_DATA, NODE_IDS, nodeDef(), validateClosingRing() (+48 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (63): ARCH_GLYPH, claimBanner(), esc(), House, HOUSES, houseSigilPath(), houseSigilSvg(), LAYOUT (+55 more)

### Community 2 - "Community 2"
Cohesion: 0.15
Nodes (28): checkBrokenRecovery(), resolveHeraldCaptures(), runOathUpkeep(), recordSuspicionLog(), checkGambitSeize(), computeTerritoryWinner(), evaluateGambitAtDawn(), getEffectivePledgeWeight() (+20 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (37): resolveHeraldCaptures(), resumeLastStand(), isKeystoneAshed(), executeAudit(), initiateAccusation(), recordSuspicionLog(), applyReckoningBlightPressure(), checkGambitSeize() (+29 more)

### Community 4 - "Community 4"
Cohesion: 0.20
Nodes (16): Death Knight Engagement (hunt verb + win-currency kill), Herald Political Build (Stage H), Monte Carlo Balance Sim (v2 harness), Oaths + the Ledger (passion spine), PPO RL Agent (v1 scrapped), Rescue/Break Economy (win-currency rescue), v1 Engine Drift (implementation vs spec), Design v2 Dark Engagement Patch (+8 more)

### Community 5 - "Community 5"
Cohesion: 0.16
Nodes (14): executeParley(), executeRecruit(), buildClosingRing(), nodeDef(), recruited(), setup(), computeCrownHolder(), createGame() (+6 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (44): author, dependencies, gsap, howler, description, devDependencies, eslint, @eslint/js (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (59): bfsDistance(), BoardValidationResult, createInitialBoardState(), NODE_IDS, validateClosingRing(), AccusationVoteCommand, ActionType, AdvancePhaseCommand (+51 more)

### Community 8 - "Community 8"
Cohesion: 0.18
Nodes (24): areAdjacent(), areSworn(), executeBreakOath(), executeClaim(), executeHeraldMarch(), executeMarch(), executeRaid(), executeRescue() (+16 more)
...
Cohesion: 0.08
Nodes (11): GameSession, DIFFICULTY_TUNABLES, difficultyTunables(), sessionTunables(), ACTS, play(), TIERS, withDifficulty() (+3 more)

### Community 28 - "Community 28"
Cohesion: 0.19
Nodes (31): areSworn(), hasRivalAtNode(), hasSKForcesAtNode(), archetypeAction(), baselineAction(), bestLooseCaptureAt(), bestStepToward(), bestStepTowardCapturableRival() (+23 more)
...
Cohesion: 0.07
Nodes (28): Balance Simulation, Commands Reference, Core files (both engines), Data & Codegen, Design Commitments (Non-Negotiable), Determinism Contract (DESIGN-V3-ALGORITHM §7), Fog-of-war projection (v3), Handoff & Verification (+20 more)
...
Cohesion: 0.09
Nodes (23): 0. Locked design decisions, 10. Layer B — Hidden-traitor (Blood Pact) [mode flag], 11. Deliberately deferred / open for Stage 3, 12. Stage-5 delta — changelog & sources, 1. Game overview, 3. Setup algorithm, 4.1 THREAT (telegraph), 4.2 THE PLEDGE — the heart (+15 more)
...
Cohesion: 0.16
Nodes (22): ActionResult, BlightResult, AuditResult, BloodPactResult, chooseAccusation(), chooseAccusationVote(), chooseAuditTarget(), executeAudit() (+14 more)
...
Cohesion: 0.12
Nodes (28): ArchetypeId, GameRunConfig, Matchup, GameMetrics, ArchetypeWinRate, BloodPactSummary, inBand(), mean() (+20 more)

### Community 59 - "Community 59"
Cohesion: 0.13
Nodes (28): livingStrongholdCount(), applyDeathBequest(), applyReckoningAutoPressure(), applyWraithCardAdds(), applyWraithNudges(), BequestChoice, boardLeaderSeat(), cardsAccountedFor() (+20 more)
...
Cohesion: 0.05
Nodes (42): 10. The Herald — the political build (advanced), 11. Blood Pact — the hidden-traitor mode (optional), 12. Player counts — three games in one, 13. Design pillars (non-negotiable), 14. Where the numbers live, and what's still unproven, 1. The pitch, 2. The design spine (read this and you understand the game), 3. The core loop (+34 more)
...
Cohesion: 0.24
Nodes (4): Forge-as-Gate Tolls (Stage T), Sealed Pledge (Stage S gambit fix), Design history — provenance, not authority, What's in here
...
Cohesion: 0.12
Nodes (18): policyOf(), traitorAtPledge(), ARCHETYPE_SEATS, game(), applySequence(), reckoningCleanDawn(), apply(), applyCommand() (+10 more)
...
Cohesion: 0.08
Nodes (35): ActionResult, executeRecruit(), BlightResult, AuditResult, BloodPactResult, CombatResult, LastStandResult, addCourtPiece() (+27 more)

### Community 81 - "Community 81"
Cohesion: 0.13
Nodes (34): Narration, hasRivalAtNode(), hasSKForcesAtNode(), parleyTarget(), archetypeAction(), baselineAction(), bestStepToward(), bestStepTowardBrokenAlly() (+26 more)
...
Cohesion: 0.22
Nodes (16): chooseAccusation(), chooseAccusationVote(), chooseAuditTarget(), isAccusationComplete(), mostSuspect(), requiredVoters(), submitAccusationVote(), suspicionScore() (+8 more)
...
Cohesion: 0.23
Nodes (23): advanceBlightOnNode(), advanceBlightOnSpoke(), applyDawnBlightAdvance(), ashNode(), checkActAdvance(), countAshedNodes(), getBlightFrontier(), getSpokeFrontier() (+15 more)
...
Cohesion: 0.14
Nodes (15): AccusationVoteCommand, AdvancePhaseCommand, Command, InitiateAccusationCommand, LastStandCommitCommand, PlayerAction, PlayerActionCommand, RaidEffect (+7 more)

### Community 90 - "Community 90"
Cohesion: 0.11
Nodes (28): traitorAtPledge(), initiateAccusation(), isAccusationComplete(), requiredVoters(), submitAccusationVote(), Command, applySequence(), apply() (+20 more)

### Community 91 - "Community 91"
Cohesion: 0.50
Nodes (3): Assets, Credits & Asset Licenses, Fonts
...
Cohesion: 0.22
Nodes (11): garrisonedGame(), placeWarlord(), chooseEffect(), chooseShadowkingIntent(), chooseTarget(), chooseTargetNode(), decayGrudge(), generateVoiceLine() (+3 more)

### Community 95 - "Community 95"
Cohesion: 0.10
Nodes (45): areAdjacent(), executeBreakOath(), executeClaim(), executeHeraldMarch(), executeMarch(), executeParley(), executeRaid(), executeRansom() (+37 more)
...
Cohesion: 0.11
Nodes (19): Archetype, ARCHETYPE_IDS, ARCHETYPES, VERB_KNOBS, VerbKnobs, GameRunResult, runAIAccusations(), runHeadlessGame() (+11 more)
...
Cohesion: 0.31
Nodes (10): addBoardPiece(), CAPTURABLE, capturePiece(), enforceGuardCap(), freeCaptiveToOwner(), guardCapacity(), removeBoardPiece(), resolveCaptivesAfterDeposals() (+2 more)
...
Cohesion: 0.43
Nodes (6): chooseAction(), runAITurn(), apply(), toAction(), toPledge(), usesBaselineBrain()
...
Cohesion: 0.40
Nodes (3): crownCalloutText(), Narration, RaidProjection
...
Cohesion: 0.33
Nodes (6): 2. Components & state, Cards & resources, Pieces, The clock, The map (`Board`) — SETTLED: "The Closing Ring with a steered front" (panel R2 consensus), Top-level `GameState` (additions/changes vs. current code)

### Community 127 - "Community 127"
Cohesion: 0.18
Nodes (12): playHeadlessGame(), bloodPactMatchups(), computeMetrics(), DiscoveryFlipMix, meanPledges(), summarizeBloodPact(), runSweep(), playFullGame() (+4 more)
...
Cohesion: 0.40
Nodes (5): 6. Victory & loss conditions — SETTLED: "Contested Throne + Gambit" (panel R2), Alternate sudden win — The Crown's Gambit (the dramatic climax), Anti-turtle / anti-stall (baseline, the judge's fix — applies regardless of win path), Default win — Territory (how ~most games end), Loss (two Shadowking win-paths — no draw)

## Knowledge Gaps
- **882 isolated node(s):** `Orchestrator protocol`, `T-001 · Wire V3.1 into the handoff machinery — `status: DONE` · `coder: sonnet` · `after: —``, `T-002 · Add gsap + howler (pinned) — `status: DONE` · `coder: sonnet` · `after: T-001``, `T-003 · Headless screenshot script (`npm run shots:v3`) — `status: DONE` · `coder: opus` · `after: T-002``, `T-004 · Baseline "before" gallery + the M2 visual rubric — `status: DONE` · `coder: sonnet` · `after: T-003`` (+877 more)
...
- **Why does `SeededRandom` connect `Community 20` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 11`, `Community 22`, `Community 23`, `Community 24`, `Community 26`, `Community 28`, `Community 45`, `Community 48`, `Community 49`, `Community 59`, `Community 79`, `Community 81`, `Community 82`, `Community 83`, `Community 86`, `Community 90`, `Community 93`, `Community 101`, `Community 103`, `Community 112`, `Community 127`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `GameState` connect `Community 79` to `Community 0`, `Community 89`, `Community 3`, `Community 100`, `Community 102`, `Community 71`, `Community 59`, `Community 109`, `Community 83`, `Community 84`, `Community 85`, `Community 120`, `Community 94`, `Community 27`, `Community 28`, `Community 95`, `Community 127`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `GameState` connect `Community 45` to `Community 2`, `Community 100`, `Community 5`, `Community 7`, `Community 8`, `Community 106`, `Community 81`, `Community 87`, `Community 57`, `Community 90`, `Community 92`, `Community 127`?**
